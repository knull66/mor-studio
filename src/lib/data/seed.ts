...
export const SEED_PORTFOLIO: PortfolioItem[] = [
  ...
  },
  {
    ...
    category: "hair",
    image_url: unsplash("photo-1519699047748-de8e457a634e"),
    alt: "Peinado recogido de novia",
    sort_order: 13,
    is_published: true,
  },
  {
    id: "p14",
    title: "Ondas de evento",
    category: "hair",
    image_url: unsplash("photo-1522337360788-8b13dee7a37e"),
    alt: "Peinado de ondas para evento",
    sort_order: 14,
    is_published: true,
  },
];
