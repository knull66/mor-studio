...
const es = {
  ...
  packages: {
    ...
    ctaStripe: "Pagar depósito 50%",
    depositOf: "Depósito 50%",
    or: "o",
    tabs: {
      makeup: "Maquillaje",
      hair: "Peinados",
    ...
    items: [
      {
        ...
        a: "Se confirma con un depósito del 50% del paquete elegido, con tarjeta (Stripe) o coordinando el pago con Elisabeth por WhatsApp. El resto se liquida el día del servicio o 7 días antes en coberturas de boda. El depósito no es reembolsable, pero puede reagendarse con 15 días de anticipación.",
      },
      {
        q: "¿Puedo pagar en la web o solo por WhatsApp?",
        a: "Las dos. En la web puedes pagar el depósito del 50% con tarjeta, Apple Pay o Google Pay (Stripe). Si prefieres hablar primero con Elisabeth, escríbele por WhatsApp y coordinan el apartado a mano. La fecha queda sujeta a confirmación en 24 horas; si no hay disponibilidad, se ofrece otra fecha o se reembolsa el depósito.",
      },
      {
  ...
  booking: {
    ...
    description:
      "Elige cómo quieres apartar: paga el depósito del 50% con tarjeta, o escribe directo a Elisabeth por WhatsApp.",
    name: "Nombre",
    phone: "Teléfono",
    email: "Correo",
    ...
    service: "Servicio",
    package: "Paquete",
    packageNone: "Aún no lo sé / cotizar",
    method: "Cómo quieres continuar",
    methodWhatsapp: "WhatsApp con Elisabeth",
    methodWhatsappHint: "Te escribimos al instante. Coordinan disponibilidad y el depósito a mano.",
    methodStripe: "Pagar depósito con tarjeta",
    methodStripeHint: "Stripe Checkout · 50% ahora. Apple Pay y Google Pay incluidos. Elisabeth confirma la fecha en 24 h.",
    depositNote: "El depósito es el 50% del paquete. El saldo se paga el día del servicio.",
    message: "Mensaje",
    placeholder: "Locación, número de personas, referencias de look…",
    submit: "Continuar por WhatsApp",
    submitStripe: "Pagar depósito",
    sending: "Enviando…",
    error: "No se pudo enviar.",
    success: "Recibimos tu solicitud. Continuamos por WhatsApp con Elisabeth.",
    successStripe: "Te llevamos a Stripe para pagar el depósito.",
    stripeMissing: "El pago con tarjeta no está activo todavía. Escríbenos por WhatsApp.",
    services: {
  ...
  maintenance: {
    ...
    body: "Este sitio no está disponible por ahora. Para más información, contacta a Vibes District.",
    cta: "Ir a Vibes District",
  },
  splash: {
    title: "MOR Studio",
  ...
  checkout: {
    eyebrow: "Reserva",
    successTitle: "Depósito recibido",
    successBody:
      "Gracias. Stripe confirmó el 50%. Elisabeth revisa la fecha y te escribe en menos de 24 horas. Si ese día no está libre, te ofrecemos otra fecha o el reembolso del depósito.",
    pendingTitle: "Estamos confirmando el pago",
    pendingBody:
      "Si ya pagaste, la confirmación puede tardar un momento. También puedes escribirle a Elisabeth por WhatsApp con tu nombre y la fecha.",
    depositPaid: "Pagado {amount}",
    cancelTitle: "Pago cancelado",
    cancelBody:
      "No se cobró nada. Puedes intentar de nuevo con tarjeta o escribirle directo a Elisabeth por WhatsApp.",
    tryAgain: "Volver al formulario",
...
const en: typeof es = {
  ...
  packages: {
    ...
    ctaStripe: "Pay 50% deposit",
    depositOf: "50% deposit",
    or: "or",
    tabs: {
      makeup: "Makeup",
      hair: "Hair",
    ...
    items: [
      {
        ...
        a: "A 50% deposit on the chosen package holds your date — pay by card (Stripe) or coordinate with Elisabeth on WhatsApp. The balance is due on the service day, or 7 days prior for wedding coverage. Deposits are non-refundable but may be rescheduled with 15 days’ notice.",
      },
      {
        q: "Can I pay on the website or only on WhatsApp?",
        a: "Both. You can pay the 50% deposit on the site with card, Apple Pay, or Google Pay (Stripe). If you would rather talk first, message Elisabeth on WhatsApp and she will hold the date with you. The date is confirmed within 24 hours; if it is unavailable, we offer another date or refund the deposit.",
      },
      {
  ...
  booking: {
    ...
    description:
      "Choose how you want to hold the date: pay the 50% deposit by card, or message Elisabeth directly on WhatsApp.",
    name: "Name",
    phone: "Phone",
    email: "Email",
    ...
    service: "Service",
    package: "Package",
    packageNone: "Not sure yet / custom quote",
    method: "How would you like to continue",
    methodWhatsapp: "WhatsApp with Elisabeth",
    methodWhatsappHint: "We message her right away. You coordinate availability and the deposit together.",
    methodStripe: "Pay the deposit by card",
    methodStripeHint: "Stripe Checkout · 50% now. Apple Pay and Google Pay included. Elisabeth confirms the date within 24 hours.",
    depositNote: "The deposit is 50% of the package. The balance is due on the service day.",
    message: "Message",
    placeholder: "Location, party size, look references…",
    submit: "Continue on WhatsApp",
    submitStripe: "Pay deposit",
    sending: "Sending…",
    error: "We couldn’t send that.",
    success: "We received your request. Continue on WhatsApp with Elisabeth.",
    successStripe: "Taking you to Stripe to pay the deposit.",
    stripeMissing: "Card payments are not active yet. Please message us on WhatsApp.",
    services: {
  ...
  maintenance: {
    ...
    body: "This site is currently unavailable. For more information, contact Vibes District.",
    cta: "Go to Vibes District",
  },
  splash: {
    title: "MOR Studio",
  ...
  checkout: {
    ...
    successBody:
      "Thank you. Stripe confirmed the 50%. Elisabeth will review the date and write within 24 hours. If that day is taken, we will offer another date or refund the deposit.",
    pendingTitle: "We’re confirming the payment",
    pendingBody:
      "If you already paid, confirmation can take a moment. You can also message Elisabeth on WhatsApp with your name and date.",
    depositPaid: "Paid {amount}",
    cancelTitle: "Payment canceled",
    cancelBody:
      "Nothing was charged. You can try the card again or message Elisabeth directly on WhatsApp.",
